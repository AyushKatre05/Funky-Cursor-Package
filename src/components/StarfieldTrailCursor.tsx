...
const StarfieldTrailCursor: React.FC<StarfieldTrailProps> = ({
  color = "#ffffff",
  size = 2,
  trails = 50,
  speed = 1,
  ...
  }, [color, size, trails, speed, lifespan, starDensity]);

  return <canvas ref={canvasRef} className="fixed top-0 left-0 w-full h-full pointer-events-none" />;
};

export default StarfieldTrailCursor;
